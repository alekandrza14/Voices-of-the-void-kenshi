        ...
        public static void SetupTerrains()
        {
            ...
            if (lightmapStaticWarn) {
                ...
                const string text = "It is recommended to disable 'Contribute GI' on terrains " +
                           ...
                           "'Contribute GI'.";
#else
                const string title = "Warning: Lightmap Static is enabled";
                const string text = "It is recommended to disable lightmapping on terrains " +
                                    "when using Digger. Otherwise there might be a visual difference between " +
                                    "Digger meshes and the terrains.\n\n" +
                                    "To disable lightmapping on a terrain, go to terrain settings and uncheck " +
                                    "'Lightmap Static'.";
#endif
